# Normative terminology · Verbindliche Terminologie · Δεσμευτική ορολογία

German is the canonical source language. Product names remain untranslated; the explanation beside them is translated.

| Deutsch | English | Ελληνικά | Rule |
|---|---|---|---|
...
| Genesis Steward | Genesis Steward | Genesis Steward (αρχικός θεματοφύλακας) | Always state that its authority expires |
| Key Burn | key burn | δημόσια καταστροφή προνομιακών κλειδιών | Must be public and technically verifiable |
| Währungssouveränität | monetary sovereignty | νομισματική κυριαρχία | A legal scenario, not a current fact |
| Annahmepflicht | mandatory acceptance / legal-tender obligation | υποχρεωτική αποδοχή | Use only with a legal qualifier |
